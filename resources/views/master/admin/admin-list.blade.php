                        ...
                        <tr>
                            ...
                            <td>
                                <a class="navbar-brand text-white" href="/master">
                                    @if( $row->name !== null )
                                        <img src="/storage/{{ $row->image }}" alt="Logo" width="40" height="40" class="d-inline-block align-text-top rounded-pill">
                                    @else
                                        <img src="/assets/img/Header-1.png" alt="Logo" width="40" height="40" class="d-inline-block align-text-top">
                                    @endif
                                </a>
                            </td>
                            <td>{{ $row->name }}</td>
