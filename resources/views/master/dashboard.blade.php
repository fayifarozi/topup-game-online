                    ...
                    <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                        <div class="categories-card">
                            <div class="d-flex align-items-center mb-24">
                                ...
                                <p class="color-palette-1 mb-0 ms-12">Transactions<br> Done</p>
                            </div>
                            <div>
                                <p class="text-sm color-palette-2 mb-1">Total</p>
                                <p class="text-2xl color-palette-1 fw-medium m-0">Rp. {{ $total }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                        <div class="categories-card">
                            <div class="d-flex align-items-center mb-24">
                                ...
                                <p class="color-palette-1 mb-0 ms-12">Product<br> Active</p>
                            </div>
                            <div>
                                <p class="text-sm color-palette-2 mb-1">Total</p>
                                <p class="text-2xl color-palette-1 fw-medium m-0">{{ $countProduct }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                        <div class="categories-card">
                            <div class="d-flex align-items-center mb-24">
                                ...
                                <p class="color-palette-1 mb-0 ms-12">Total<br> Order</p>
                            </div>
                            <div>
                                <p class="text-sm color-palette-2 mb-1">Total</p>
                                <p class="text-2xl color-palette-1 fw-medium m-0">{{ $countOrder }}</p>
                            </div>
                        </div>
                    </div>
                </div>
